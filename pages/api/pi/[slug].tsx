    ...
    (
      ...
      >
        {(poll.options || []).slice(0, 2).map((option, index) => (
          <div
            key={index}
            tw="relative flex flex-1 flex-col items-center overflow-hidden p-4 first:border-b md:first:border-r text-center"
          >
            ...
            <div tw="absolute top-0 w-full grow overflow-hidden bg-opacity-25 py-2 text-white ">
